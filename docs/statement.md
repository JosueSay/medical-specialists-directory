...
| Un mecanismo de búsqueda con sufijo agentivo (`cardiólogo zona 10`) | Formas que nombran establecimientos (`cardiologia zona 10`) | Places API indexa negocios, no personas. La desviación se verifica de forma empírica antes de la corrida completa                                                                                                                            |
