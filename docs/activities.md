...
| `SPECIALTY_KEYWORD_VARIANTS` ya incluye el agentivo en las diez especialidades                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | **Comprobado en las diez**, no solo en cardiología: todas aportan registros exclusivos frente a la disciplina |
...
| P1-12, cobertura por campo: repetida en las diez especialidades, zona 10. Teléfono alto y parejo (90-100%); sitio web muy variable (30% cardiología, 80% ginecología). Detalle en [design.md](design.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Hecho para zona 10; otras zonas quedan pendientes de que la recolección avance ahí                            |
...
| ~~Verificar el agentivo en las nueve especialidades restantes~~ **Resuelta**: las nueve aportan registros exclusivos, sin excepción. Detalle en [design.md](design.md) | P1                      | Semana 2, antes de la corrida completa |
