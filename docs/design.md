...
Tres fallos aparecieron al ejecutar el despliegue completo, ninguno visible en desarrollo local porque ahí no existe el salto de Hosting, ni un origen de navegador distinto del propio backend, ni la distinción entre una build de desarrollo y una de producción:
